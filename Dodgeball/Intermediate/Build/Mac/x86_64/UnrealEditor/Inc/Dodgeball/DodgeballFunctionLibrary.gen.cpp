...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDodgeballFunctionLibrary, UDodgeballFunctionLibrary::StaticClass, TEXT("UDodgeballFunctionLibrary"), &Z_Registration_Info_UClass_UDodgeballFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDodgeballFunctionLibrary), 1548566176U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h_3597147224(TEXT("/Script/Dodgeball"),
		Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_DodgeballFunctionLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
