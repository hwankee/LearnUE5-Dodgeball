...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULookAtActorComponent_Statics::Class_MetaDataParams[] = {
	...
	struct Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_LookAtActorComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_LookAtActorComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULookAtActorComponent, ULookAtActorComponent::StaticClass, TEXT("ULookAtActorComponent"), &Z_Registration_Info_UClass_ULookAtActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULookAtActorComponent), 3099559158U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_LookAtActorComponent_h_3668014070(TEXT("/Script/Dodgeball"),
		Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_LookAtActorComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Dodgeball_Source_Dodgeball_LookAtActorComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
